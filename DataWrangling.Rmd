...
```{r}
county = read_xlsx("./County.xlsx")
state = read_xlsx("./State.xlsx")
access = read_xlsx("./Access.xlsx")
stores = read_xlsx("./Stores.xlsx")
restaurants = read_xlsx("./Restaurants.xlsx")
assistance = read_xlsx("./Assistance.xlsx")
insecurity = read_xlsx("./Insecurity.xlsx")
taxes = read_xlsx("./Taxes.xlsx")
local = read_xlsx("./Local.xlsx")
health = read_xlsx("./Health.xlsx")
socioecon = read_xlsx("./SocioEconomic.xlsx")
