...
coef(train.model) # Predictors: Large Hass [X4225], Extra large bags [XLarge.Bags], Organic avocados [typeorganic], Low access to store in 2010 [LACCESS_POP10], Low access to store in 2015 [LACCESS_POP15], Low income and low access to store in 2010 [LACCESS_LOWI10], Children with low access to store in 2015 [LACCESS_CHILD15], Percent Hispanic in 2010 [PCT_HISP10]
plot(train.model)
